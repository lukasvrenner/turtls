...
mod tests {
    ...
    fn sub_bytes() {
        ...
        let output_state: [u8; 16] = [
            0xd4, 0x27, 0x11, 0xae, 0xe0, 0xbf, 0x98, 0xf1, 0xb8, 0xb4, 0x5d,
            0xe5, 0x1e, 0x41, 0x52, 0x30,
        ];
    ...
    fn shift_rows() {
        ...
        let output_state: [u8; 16] = [
            0xd4, 0xbf, 0x5d, 0x30, 0xe0, 0xb4, 0x52, 0xae, 0xb8, 0x41, 0x11,
            0xf1, 0x1e, 0x27, 0x98, 0xe5,
        ];
    ...
    fn mix_columns() {
        ...
        let output_state: [u8; 16] = [
            0x04, 0x66, 0x81, 0xe5, 0xe0, 0xcb, 0x19, 0x9a, 0x48, 0xf8, 0xd3,
            0x7a, 0x28, 0x06, 0x26, 0x4c,
        ];
